...
add_arg('use_gpu',          bool,   0,   "Use GPU or not.")
...
add_arg('model_path',       str,
        ...
        # '/home/chris/git/DeepSpeech/models/baidu_en8k/params.pdparams',
        'models/baidu_en8k',
...
def start_server():
    ...
    print('prepare vocab list')
    vocab_list = [chars.encode("utf-8") for chars in data_generator.vocab_list]
    print('vocab_list:', vocab_list)

    print('prepare scorer')
    if args.decoding_method == "ctc_beam_search":
        print('args.lang_model_path:', args.lang_model_path)
        assert os.path.isfile(args.lang_model_path)
        ds2_model.init_ext_scorer(args.alpha, args.beta, args.lang_model_path, vocab_list)

    print('prepare ASR inference handler')
